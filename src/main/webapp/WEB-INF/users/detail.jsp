					...
					<form action="index/addcart.action" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
						...
						<ul class="ul2 clearfix">
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>市场价：</strong><font class="shop" id="ECS_SHOPPRICE">￥${goods.price }元</font>
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
						...
						<c:if test="${goods.storage ne '0'}">
							<ul class="bnt_ul">
								...
								<li class="padd"><input type="image" src="themes/ecmoban_jumei/images/goumai2.gif" /></li>
							</ul>
						</c:if>
					</form>
				</div>
							...
							<ul class="comments">
								<c:forEach items="${topicList}" var="topic">
									<li class="word"><font class="f2">${topic.username } </font> <font class="f3">(${topic.addtime }) </font>
										<br /> <img src="themes/ecmoban_jumei/images/stars${topic.num }.gif" />
