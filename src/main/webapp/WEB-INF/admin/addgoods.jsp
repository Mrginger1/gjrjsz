	...
	<div style="margin: 15px;">
		...
		<form id="addForm" class="layui-form" action="goods/addGoods.action" name="myform" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<select name="cateid" id="cateid"><option value="">---请选择商品类型--</option>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="price" class="layui-input" id="price" placeholder="请输入销售价" />
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="storage" class="layui-input" id="storage" placeholder="请输入库存数" />
				</div>
			</div>
			<div class="layui-form-item">
