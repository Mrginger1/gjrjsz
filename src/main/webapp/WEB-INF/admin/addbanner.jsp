...
<body>
	<div style="margin: 15px;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
			<legend>新增网站栏目信息</legend>
		</fieldset>
		<form id="addForm" class="layui-form" action="banner/addBanner.action" name="myform" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">栏目名称</label>
				<div class="layui-input-inline" style="width: 45%;">
					<input type="text" name="bannername" class="layui-input" id="bannername" placeholder="请输入栏目名称" />
				</div>
			</div>
			<div class="layui-form-item">
