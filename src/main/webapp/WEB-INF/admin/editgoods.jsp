		...
		<form id="addForm" class="layui-form" action="goods/updateGoods.action" name="myform" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline shortInput">
					<input type="radio" name="recommend" value="是" title="是" ${goods.recommend == "是"?"checked":""}> <input
						type="radio" name="recommend" value="否" title="否" ${goods.recommend == "否"?"checked":""}>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">是否特价</label>
				<div class="layui-input-inline shortInput">
					<input type="radio" name="special" value="是" title="是" ${goods.special == "是"?"checked":""}> <input
						type="radio" name="special" value="否" title="否" ${goods.special == "否"?"checked":""}>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<input type="hidden" name="goodsid" id="goodsid" value="${goods.goodsid}" /><input type="hidden" name="sellnum"
						id="sellnum" value="${goods.sellnum}" /> <input type="hidden" name="addtime" id="addtime"
						value="${goods.addtime}" /> <input type="hidden" name="hits" id="hits" value="${goods.hits}" />
